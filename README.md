...
- [ ] Explain what a token is used for.
      A token is uesd for securely transmitting information between client and server as a JSON object.
- [ ] What steps can you take in your web apps to keep your data secure?
      A couple of steps you can take to keep your data secure is having a login that gets an auth token in order to get and view the data.
- [ ] Describe how web servers work.
      First an IP address is obtained from the domain name, then the browser requests the full URL, then the server will respond to that request, and finally the browser will display the page.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      PUT is the U in CRUD, DELETE HTTP is the D in CRUD.
